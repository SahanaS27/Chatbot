...
//                             } 
//                         }
//                         else if(menuResp.contains("order")|| menuResp.contains("ye")||menuResp.contains("ice")){
//                             chatbot.order();
//                             String newOrderResp = (myObj.nextLine()).toLowerCase();
//                             if(newOrderResp.contains("recc") || newOrderResp.contains("sugg")||newOrderResp.contains("think")){
//                                 System.out.println("I recommend trying one of our world-famous ice cream cakes! Would you like one?");
//                                 String suggResp = (myObj.nextLine()).toLowerCase();
//                                 if(suggResp.equals("q")){
//                                     chatbot.quit();
...
//                                 }
//                             }
//                             else if (newOrderResp.contains("cake")||newOrderResp.contains("world")||newOrderResp.contains("famous")||newOrderResp.contains("ice")){
//                                 chatbot.cake(myObj);
//                                 int y = chatbot.finishCheck(myObj);
//                                 if(y==1){
//                                     chatbot.finish();
...
//                                 }
//                             }
//                             else if(newOrderResp.contains("sund")){
//                                 chatbot.sundae(myObj);
//                                 int y = chatbot.finishCheck(myObj);
//                                 if(y==1){
//                                     chatbot.finish();
...
//                                 } 
//                             }
//                             else if(newOrderResp.contains("scoop")){
//                                 chatbot.scoops(myObj);
//                                 int y = 
import java.util.Scanner;
public class App {
